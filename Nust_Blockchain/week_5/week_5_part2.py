...
# this code snippet is for part_2
...
def assesment(Senders_email_address ,recipient_email_address,email_subject,message_body,Nonce):
     ...
     # local variable for attempt calculation 
   Attempts=0;
   ...
   while True:
       ...
       hashed_com=hashed(concatenated)
    
    #  checking difficulty
       
       if hashed_com[:4]=='ffff':
           return Attempts ,Nonce ,hashed_com
       else: 
           Nonce=Nonce+1
